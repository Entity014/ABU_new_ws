...
static const _MyArray_type_support_symbol_names_t _MyArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rabbit_interfaces, msg, MyArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rabbit_interfaces, msg, MyArray)),
  }
};
...
{
  return &::rabbit_interfaces::msg::rosidl_typesupport_cpp::MyArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rabbit_interfaces, msg, MyArray)() {
  return get_message_type_support_handle<rabbit_interfaces::msg::MyArray>();
}
