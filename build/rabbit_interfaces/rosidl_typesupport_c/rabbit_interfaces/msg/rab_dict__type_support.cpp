...
static const _RabDict_type_support_symbol_names_t _RabDict_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rabbit_interfaces, msg, RabDict)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rabbit_interfaces, msg, RabDict)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rabbit_interfaces, msg, RabDict)() {
  return &::rabbit_interfaces::msg::rosidl_typesupport_c::RabDict_message_type_support_handle;
}
